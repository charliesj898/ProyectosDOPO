...
public class Cup {
    ...
    leftWall.changeSize(totalHeight, WALL_THICKNESS);
    
    this.rightWall = new Rectangle();
    rightWall.changeColor(color);
    rightWall.changeSize(totalHeight, WALL_THICKNESS);
    ...
    // mover pared derecha
    rightWall.moveHorizontal((x + totalWidth - WALL_THICKNESS) - rightX);
    rightWall.moveVertical(y - rightY);
    rightX = x + totalWidth - WALL_THICKNESS;
    rightY = y;
