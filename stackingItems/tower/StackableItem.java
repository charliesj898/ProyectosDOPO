 ...
 * Provee estado comun como el numero, identificacion de color y control de
 * visibilidad.
 * 
...
public abstract class StackableItem implements DrawableItem {
     ...
     * Al ser abstracta, cada subclase (taza, tapa) define su propia regla de
     * altura.
     * 
     * @return altura en cm
     */
    ...
    /**
     * Clona el item (Polimorfismo).
     */
    public abstract StackableItem createCopy();

    /**
     * Verifica si este item es una Taza.
     */
    public abstract boolean isCup();

    /**
     * Verifica si este item es una Tapa.
     */
    ...
    /**
     * Verifica si es la Tapa Loca (polimorfismo especial).
     */
