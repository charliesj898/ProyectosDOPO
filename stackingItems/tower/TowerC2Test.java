 ...
 * Siguiendo la premisa de "No olvidar diseÃ±ar preguntas: q deberia y q no
 * deberia hacer"
 */
public class TowerC2Test {
    ...
    public void accordingASShouldCreateTowerWithCups() {
        ...
        assertEquals("4", items[3][1]); // Ultima taza apilada en la cima es la nÂ° 4
        assertTrue(tower.ok());
    }

    @Test
    public void accordingASShouldCoverLids() {
        // Que deberia hacer: Al introducir tapas en cualquier orden, cover() las sitÃºa
        // con precisiÃ³n
        tower.pushLid(2);
        tower.pushLid(4);
    ...
    public void accordingASShouldInvalidSwapRevertsGracefully() {
        // Que NO deberia hacer: Permitir un swap que fÃ­sicamente rompa las
        // restricciones
